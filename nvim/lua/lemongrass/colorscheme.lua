...
vim.cmd([[hi Normal guibg=#1b1730]]) -- global BG color?
vim.cmd([[hi SignColumn guibg=#1b1730]]) -- gutter (i think)
-- https://stackoverflow.com/questions/250652/vim-initial-settings-change-background-color-for-line-number-on-the-left-side
vim.cmd([[hi LineNr guibg=#1b1730 ctermbg=DarkGreen]]) -- numbers at gutter
