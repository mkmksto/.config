...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'nvim-markdown', 'toggle-checkbox.nvim', 'follow-md-links.nvim', 'nvim-treesitter', 'clipboard-image.nvim', 'markdown-preview.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp-buffer', 'cmp-nvim-lsp-signature-help', 'cmp-path'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
