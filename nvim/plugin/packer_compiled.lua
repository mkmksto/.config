...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'toggle-checkbox.nvim', 'clipboard-image.nvim', 'nvim-markdown', 'follow-md-links.nvim', 'markdown-preview.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
