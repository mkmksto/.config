...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'follow-md-links.nvim', 'toggle-checkbox.nvim', 'markdown-preview.nvim', 'nvim-markdown', 'clipboard-image.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
