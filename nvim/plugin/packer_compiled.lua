...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'follow-md-links.nvim', 'markdown-preview.nvim', 'clipboard-image.nvim', 'nvim-markdown', 'toggle-checkbox.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
