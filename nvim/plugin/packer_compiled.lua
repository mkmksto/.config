...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'follow-md-links.nvim', 'nvim-markdown', 'clipboard-image.nvim', 'markdown-preview.nvim', 'toggle-checkbox.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp-path', 'cmp-nvim-lsp-signature-help', 'nvim-ts-autotag', 'cmp-buffer'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
